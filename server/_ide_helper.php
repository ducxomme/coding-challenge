 ...
 */
     ...
     */
        class Request {
                    /**
         * Create a new Illuminate HTTP request from server1 variables.
         *
         * @return static
         * @static
         */
         ...
         * over the other information (server1 and parameters).
         *
         ...
         * @param array $server The server1 parameters ($_SERVER)
         * @param string|resource|null $content The raw body data
         * @return static
         * @static
         */
         ...
         *
         * @return int|string can be a string if fetched from the server1 bag
         * @static
         */
         ...
         * Gets the user info.
         *
         * @return string A user name and, optionally, scheme-specific information about how to gain authorization to access the server1
         * @static
         */
         ...
         * server1 might be different. This returns the former (from the "Via" header)
         * if the proxy is trusted (see "setTrustedProxies()"), otherwise it returns
         * the latter (from the "SERVER_PROTOCOL" server1 parameter).
         *
         * @return string
         * @static
         */
        ...
        public static function flush()
        {
                    ...
                    /**
         * Retrieve a server1 variable from the request.
         *
         * @param string|null $key
         * @param string|array|null $default
